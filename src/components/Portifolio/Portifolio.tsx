...
const Portifolio = () => {
  ...
  return (
      <section id="servicos" className="py-35 bg-slate-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 ">
        {projects.map((projects, index) => (
          <motion.div
            ...
            className="bg-white p-8 rounded-2xl shadow-2xs hover:shadow-xl transition-all group border border-transparent hover:border-brand-green/20"
          >
            <div>
